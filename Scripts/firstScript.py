...
traindata = trdata.flow_from_directory(
    directory=".././Datasets/writerPair1/0-10/train", target_size=(224, 224))
tsdata = ImageDataGenerator()
testdata = tsdata.flow_from_directory(directory=".././Datasets/writerPair1/0-10/test", target_size=(224, 224))
